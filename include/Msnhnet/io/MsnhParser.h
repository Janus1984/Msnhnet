...
public:
    explicit BaseParams(bool incIndex) {
        if (incIndex) {
            index++;
        }
    }
...
public:
    explicit NetConfigParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit EmptyParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ViewParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit PermuteParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ClipParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit PixshuffleParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit SliceParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ReductionParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ActivationParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ConvParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit DeConvParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit MaxPoolParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit LocalAvgPoolParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit GlobalAvgPoolParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ConnectParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit BatchNormParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ResBlockParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit Res2BlockParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit ConcatBlockParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit AddBlockParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit RouteParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit VariableOpParams(bool incIndex) : BaseParams(incIndex) {
        this->type = LayerType::VARIABLE_OP;
    }

    enum class VarOpType {
        VAR_OP_ADD = 0,
        VAR_OP_SUB,
        VAR_OP_SUB_INV,
        VAR_OP_MUL,
    ...
    std::vector<int> layerIndexes;
    VarOpType varOpType = VarOpType::VAR_OP_ADD;
    float constVal = 0;
...
public:
    explicit SoftMaxParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit UpSampleParams(bool incIndex) : BaseParams(incIndex) {
        this->type = LayerType::UPSAMPLE;
    }
    enum class UpsampleType : std::uint8_t {
        NEAREST = 0,
        BILINEAR,
    };
    ...
    UpsampleType upsampleType = UpsampleType::NEAREST;
...
public:
    explicit YoloParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit YoloOutParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    explicit PaddingParams(bool incIndex) : BaseParams(incIndex) {
...
public:
    ...
    void parseConfigParams(NetConfigParams* netConfigParams,
                           YAML::const_iterator& iter);
    void parseActivationParams(ActivationParams* activationParams,
                               YAML::const_iterator& iter);
    void parseMaxPoolParams(MaxPoolParams* maxPoolParams,
                            YAML::const_iterator& iter);
    void parseLocalAvgPoolParams(LocalAvgPoolParams* localAvgPoolParams,
                                 YAML::const_iterator& iter);
    void parseGlobalAvgPoolParams(GlobalAvgPoolParams* globalAvgPoolParams,
                                  YAML::const_iterator& iter);
    void parseConvParams(ConvParams* convParams,
                         YAML::const_iterator& iter);
    void parseDeConvParams(DeConvParams* deconvParams,
                           YAML::const_iterator& iter);
    void parseConnectParams(ConnectParams* connectParams,
                            YAML::const_iterator& iter);
    void parseBatchNormParams(BatchNormParams* batchNormParams,
                              YAML::const_iterator& iter);
    void parseEmptyParams(EmptyParams* emptyParams,
                          YAML::const_iterator& iter);
    void parseViewParams(ViewParams* viewParams,
                         YAML::const_iterator& iter);
    void parsePermuteParams(PermuteParams* permuteParams,
                            YAML::const_iterator& iter);
    void parseClipParams(ClipParams* clipParams,
                         YAML::const_iterator& iter);
    void parsePixShuffleParams(PixshuffleParams* pixShuffleParams,
                               YAML::const_iterator& iter);
    void parseSliceParams(SliceParams* sliceParams,
                          YAML::const_iterator& iter);
    void parsePaddingParams(PaddingParams* paddingParams,
                            YAML::const_iterator& iter);
    void parseReductionParams(ReductionParams* reductionParams,
                              YAML::const_iterator& iter);
    void parseResBlockParams(ResBlockParams* resBlockParams,
                             YAML::const_iterator& iter);
    void parseRes2BlockParams(Res2BlockParams* res2BlockParams,
                              YAML::const_iterator& iter);
    void parseConcatBlockParams(ConcatBlockParams* concatBlockParams,
                                YAML::const_iterator& iter);
    void parseAddBlockParams(AddBlockParams* addBlockParams,
                             YAML::const_iterator& iter);
    void parseRouteParams(RouteParams* routeParams,
                          YAML::const_iterator& iter);
    void parseVariableOpParams(VariableOpParams* variableOpParams,
                               YAML::const_iterator& iter);
    void parseSoftMaxParams(SoftMaxParams* softmaxParams,
                            YAML::const_iterator& iter);
    void parseUpSampleParams(UpSampleParams* upSampleParams,
                             YAML::const_iterator& iter);
    void parseYoloParams(YoloParams* yoloParams,
                         YAML::const_iterator& iter);
    void parseYoloOutParams(YoloOutParams* yoloOutParams,
                            YAML::const_iterator& iter);
};
}  // namespace Msnhnet
